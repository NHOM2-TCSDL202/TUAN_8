...
values 
		('HD0000001','KH0000001','NV0000001',null,getdate()+1,getdate()+4,'PX00000001',N'15 Lý Thường Kiệt'),
		('HD0000002','KH0000001','NV0000002',null,getdate()+2,getdate()+4,'PX00000002',N'22 Nguyễn Tất Thành'),
		('HD0000003','KH0000003','NV0000001',null,getdate(),getdate()+4,'PX00000001',N'12 Lý Thường Kiệt'),
		('HD0000004','KH0000004','NV0000004',null,getdate(),getdate()+4,'PX00000004',N'26 Quang Trung'),
		('HD0000005','KH0000005','NV0000005',null,getdate()+1,getdate()+4,'PX00000003',N'66 Điện Biên Phủ');
...
update DONDATHANG
	set DONDATHANG.maPX = KHACHHANG.maPX
	from KHACHHANG
	where 
		DONDATHANG.MAKHACHHANG = KHACHHANG.MAKHACHHANG and
		DONDATHANG.maPX = NULL
...
FROM KHACHHANG
JOIN PhuongXa ON KHACHHANG.maPX = PhuongXa.maPX
JOIN NHACUNGCAP ON PhuongXa.maPX = NHACUNGCAP.maPX
WHERE 
...
update NHANVIEN
	...
	where MANHANVIEN in (
		select top 1 with ties NHANVIEN.MANHANVIEN
		from NHANVIEN
		join DONDATHANG on NHANVIEN.MANHANVIEN = DONDATHANG.MANHANVIEN
		join CHITIETDATHANG on CHITIETDATHANG.SOHOADON = DONDATHANG.SOHOADON
		group by NHANVIEN.MANHANVIEN
